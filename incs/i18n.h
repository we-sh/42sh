...
static const char		*g_i18n_fr[] = {
	...
	[ST_BLTIN_FOLD] = "rompt les lignes à une certaine largeur maximale",
	[ST_BLTIN_FOLD_ERR_ILLEGALW] = "largeur invalide",
	[ST_BLTIN_FOLD_OPT_S] = "rompt en fonction du caractère <espace>",
	[ST_BLTIN_FOLD_OPT_W] = "largeur maximale (par défaut 80)",
...
static const char		*g_i18n_en[] = {
	...
	[ST_BLTIN_FOLD] = "break the lines to have a maximum of width column",
	[ST_BLTIN_FOLD_ERR_ILLEGALW] = "illegal width value",
	[ST_BLTIN_FOLD_OPT_S] = "break the line after the last such <blank>",
	[ST_BLTIN_FOLD_OPT_W] = "maximum width (80 by default)",
