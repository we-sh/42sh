...
/*
** This file contains translations of all status messages
...
** For each static translation table, the first key ST_OK must contain the
** name of the described language
*/
