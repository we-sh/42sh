...
static const char		*g_i18n_fr[] = {
	...
	[ST_BLTIN_SETENV_ALPHA_NUM] = "setenv: Le nom de variable doit contenir des characters alphanumeric.",
	[ST_BLTIN_SETENV_FIRST_CHAR] = "setenv: Le nom de variable doit commencer avec une lettre.",
	[ST_DONE] = "terminé",
	[ST_RUNNING] = "en cours",
...
static const char		*g_i18n_en[] = {
	...
	[ST_BLTIN_SETENV_ALPHA_NUM] = "setenv: Variable name must contain alphanumeric characters.",
	[ST_BLTIN_SETENV_FIRST_CHAR] = "setenv: Variable name must begin with a letter.",
	[ST_DONE] = "done",
	[ST_RUNNING] = "running",
	[ST_USAGE] = "usage"
};
