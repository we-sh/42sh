...
int					globbing_load_context(t_ctx **ctx,
											char *arg);
int					globbing_bracket(t_mylist **list,
										char *input,
										char *match);
int					globbing_remove_double(t_tmp **concat);
void				globbing_sort_list_glob(t_list **argv_list);
int					globbing_run_parse(t_argv *arg,
										t_list *list_glob);
void				globbing_context_delete(t_ctx *ctx);
int					globbing_happend_to_list(t_mylist **list,
												char *input);
...
int					globbing_bracket_exp_subsequence(t_tmp **concat,
														int i);
int					globbing_bracket_recurse(t_mylist **list,
												t_tmp *concat,
												char *match,
												int i);
int					globbing_before_expand(t_tmp **concat,
											int i,
											int len);
int					globbing_check(char *pattern, char *input);
int					globbing_add_node_to_list(t_list *argv_list,
												t_argv *arg_base);
